...
function requirePump () {
	...
	var fs$1 = fs.default; // we only need fs to get the ReadStream and WriteStream prototypes
...
const extractZip = /*@__PURE__*/getDefaultExportFromCjs(extractZipExports);
