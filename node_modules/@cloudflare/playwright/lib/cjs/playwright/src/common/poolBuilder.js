...
class PoolBuilder {
  ...
  _buildPoolForTest(test, testErrors) {
    ...
    for (const parent of parents) {
      if (parent._use.length)
        pool = new fixtures.FixturePool(parent._use, (e) => this._handleLoadError(e, testErrors), pool, parent._type === "describe");
  ...
  _buildTestTypePool(testType, testErrors) {
    if (!this._testTypePools.has(testType)) {
      ...
      const pool = new fixtures.FixturePool(testType.fixtures, (e) => this._handleLoadError(e, testErrors), void 0, void 0, optionOverrides);
