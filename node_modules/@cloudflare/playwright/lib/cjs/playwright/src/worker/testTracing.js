...
const util$1 = require('../isomorphic/util.js');
...
class TestTracing {
  ...
  appendTopLevelAttachment(attachment) {
    const callId = `${util$1.kTopLevelAttachmentPrefix}@${++this._lastActionId}`;
    this.appendBeforeActionForStep(callId, void 0, util$1.kTopLevelAttachmentPrefix, `${util$1.kTopLevelAttachmentPrefix} "${attachment.name}"`, void 0, []);
