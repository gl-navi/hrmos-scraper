...
function createPageBindingScript(playwrightBinding, name, needsHandle) {
  const script = `(${addPageBinding.toString()})(${JSON.stringify(playwrightBinding)}, ${JSON.stringify(name)}, ${needsHandle}, (${utilityScriptSerializers.source}), (${builtins.builtins})())`;
