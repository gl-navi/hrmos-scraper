...
class BidiPage {
  ...
  _onLogEntryAdded(params) {
    ...
    this._page._addConsoleMessage(entry.method, entry.args.map((arg) => bidiExecutionContext.createHandle(context, arg)), location, params.text || void 0);
  }
...
exports.addMainBinding = addMainBinding;
