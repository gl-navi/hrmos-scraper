...
class AndroidDeviceDispatcher extends dispatcher.Dispatcher {
  constructor(scope, device) {
    ...
    this.addObjectListener(android.AndroidDevice.Events.Close, (socketName) => this._dispatchEvent("close"));
  }
  static from(scope, device) {
    const result = dispatcher.existingDispatcher(device);
  ...
  async connectToWebView(params) {
    return { context: new browserContextDispatcher.BrowserContextDispatcher(this, await this._object.connectToWebView(params.socketName)) };
  }
}
