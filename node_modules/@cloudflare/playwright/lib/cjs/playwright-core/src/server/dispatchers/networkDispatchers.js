...
class RequestDispatcher extends dispatcher.Dispatcher {
  static from(scope, request) {
    const result = dispatcher.existingDispatcher(request);
  ...
  constructor(scope, request) {
    ...
    const pageDispatcher$1 = page ? dispatcher.existingDispatcher(page) : null;
...
class ResponseDispatcher extends dispatcher.Dispatcher {
  ...
  static from(scope, response) {
    const result = dispatcher.existingDispatcher(response);
...
class RouteDispatcher extends dispatcher.Dispatcher {
  ...
  static from(scope, route) {
    const result = dispatcher.existingDispatcher(route);
