...
const utilityScriptSerializers$1 = require('../utils/isomorphic/utilityScriptSerializers.js');

const utilityScriptSerializers = utilityScriptSerializers$1.source(builtins.builtins());
  ...
  _utilityScript() {
    if (!this._utilityScriptPromise) {
      ...
      (() => {
        ...
        return new (module.exports.UtilityScript())(${debug.isUnderTest()});
      })();`;
