...
const debug = require('../../../protocol/debug.js');
...
class Tracing extends instrumentation.SdkObject {
  ...
  async stopChunk(params) {
    ...
    if (this._state)
      this._state.recording = false;
    if (error) {
      if (this._context instanceof browserContext.BrowserContext && !this._context._browser.isConnected())
        return {};
      throw error;
    }
...
function shouldCaptureSnapshot(metadata) {
  return debug.commandsWithTracingSnapshots.has(metadata.type + "." + metadata.method);
}
