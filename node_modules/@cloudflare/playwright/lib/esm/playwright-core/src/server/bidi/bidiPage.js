...
import { BrowsingContext, Script } from './third_party/bidiProtocolCore.js';
...
class BidiPage {
  ...
  _onLogEntryAdded(params) {
    ...
    this._page._addConsoleMessage(entry.method, entry.args.map((arg) => createHandle(context, arg)), location, params.text || void 0);
  }
...
export { BidiPage, addMainBinding, kPlaywrightBindingChannel };
