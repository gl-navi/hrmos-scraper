import * as playwright from '@cloudflare/playwright/test';
...
class Context {
  ...
  async run(tool, params) {
    ...
    try {
      if (waitForNetwork)
        actionResult = await waitForCompletion(this, tab.page, async () => racingAction?.()) ?? void 0;
      else
...
export { Context, Tab, generateLocator };
